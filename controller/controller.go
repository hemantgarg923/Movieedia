...
import (
	...
	"github.com/hemantgarg925/mymongo/model"
...
// mongodb helpers functions (separate file preferred)
...
func deleteOneMovie(movieId string) {
	...
	fmt.Println("successfully deleted with delete count : ", deletecount)
}

// delete all records
func deleteAllMovie() {
	filter := bson.D{{}}
	deleteResult, _ := collection.DeleteMany(context.Background(), filter)
	fmt.Println("deleted all movies and deletecount is: ", deleteResult.DeletedCount)
}
...
// Actual controllers (preferred separate file)
